...
**Industry:** Financial Services · **Personas:** Loan Officers; Processors; Underwriters · **Featured tools:** Dynamics 365 CRM, Dynamics 365 ERP, Microsoft Teams
...
1. **Copilot Studio → Solutions → Import solution** → `copilot_studio_solution/MortgageOriginationAgentMcpConnectors_1_0_0_1.zip` → Import.
2. Repeat for `copilot_studio_solution/MortgageOriginationAgentMcpAgents_1_0_0_1.zip`.
3. Open **MortgageOriginationAgent** and **Publish**.
4. **Tools → Add a tool → Model Context Protocol** → the `Mortgage Origination Agent` connector → no-auth connection → Add → Publish.
...
[`skill/SKILL.md`](skill/SKILL.md) + [`skill/mortgage-origination-agent.py`](skill/mortgage-origination-agent.py) are a
framework-free skill: run `python skill/mortgage-origination-agent.py "list"`, import `query()`, or
