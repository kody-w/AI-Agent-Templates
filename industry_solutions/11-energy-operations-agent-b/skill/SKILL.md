---
name: energy-operations-agent-b
...
## Use it
- CLI: `python energy-operations-agent-b.py "list"` (all site records) or `python energy-operations-agent-b.py "<name or SITE- id>"`.
- Import: `from energy_operations_agent_b import query; query("list")`.
