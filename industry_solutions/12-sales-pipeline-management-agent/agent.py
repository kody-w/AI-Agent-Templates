...
class SalesPipelineManagementAgent(BasicAgent):
    ...
    def __init__(self):
        self.name = "SalesPipelineManagementAgent"
        self.metadata = {
            "name": self.name,
            "description": (
                "Automate sales pipeline management to keep deals moving, increase forecast confidence, and improve team productivity. Records live in Microsoft Dataverse (synthetic, no "
                ...
                "properties": {
                    "reference": {
                        ...
                        "description": ("A opportunity reference or a subject "
                                        "name, e.g. OPP-10240 or 'Coho Vineyard'. Pass 'list' to "
    ...
    def perform(self, **kwargs):
        ...
        if not ref or ref.lower() == "list":
            lines = ["## Sales Pipeline Management Agent — opportunity records (Dataverse)"]
