---
name: energy-operations-agent-c
...
## Use it
- CLI: `python energy-operations-agent-c.py "list"` (all site records) or `python energy-operations-agent-c.py "<name or SITE- id>"`.
- Import: `from energy_operations_agent_c import query; query("list")`.
